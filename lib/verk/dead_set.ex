defmodule Verk.DeadSet do
  ...
  @doc """
  Move the job out of the dead set to be retried immediately
  ...
  def requeue_job(original_json, redis), do: SortedSet.requeue_job(@dead_key, original_json, redis)

  @doc """
  Move the job out of the dead set to be retried immediately, raising if there's an error
